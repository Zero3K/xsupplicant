...
} bool IPCConnectTest::setupTest() 
{
			    ...
			    ("Unable to establish IPC connection with the supplicant engine!\n");
		...
		innerError("It took the test program " + Util::itos(i) +
...
bool IPCConnectTest::teardownTest() 
{
		    ...
		    ("Unable to terminate IPC connection with the supplicant engine!\n");
