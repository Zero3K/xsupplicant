...
Util::myDisconnect(m_pConnectionsTable,
				    SIGNAL(itemSelectionChanged()), this,
				    SLOT(handleConnectionListSelectionChange
					 ()));
		
Util::myDisconnect(m_pConnectionsTable,
				    SIGNAL(cellDoubleClicked(int, int)), this,
				    SLOT(handleDoubleClick(int, int)));
...
Util::myDisconnect(m_pDeleteConnButton, SIGNAL(clicked()),
				    this, SLOT(deleteSelectedConnection()));
	

if (m_pEditConnButton != NULL)
		
Util::myDisconnect(m_pEditConnButton, SIGNAL(clicked()), this,
				    SLOT(editSelectedConnection()));
	

if (m_pNetworkPrioritiesButton != NULL)
		
Util::myDisconnect(m_pNetworkPrioritiesButton,
				    SIGNAL(clicked()), this,
				    SLOT(showPriorityDialog()));
	

if (m_pNewConnButton != NULL)
		
Util::myDisconnect(m_pNewConnButton, SIGNAL(clicked()), this,
				    SLOT(createNewConnection()));
	

if (m_pWirelessAutoConnect != NULL)
		
Util::myDisconnect(m_pWirelessAutoConnect,
				    SIGNAL(stateChanged(int)), this,
				    SLOT(enableDisableWirelessAutoConnect
					 (int)));
	

if (m_pWiredAutoConnect != NULL)
		
Util::myDisconnect(m_pWiredAutoConnect,
				    SIGNAL(stateChanged(int)), this,
				    SLOT(enableDisableWiredAutoConnect(int)));
	

if (m_pWiredConnections != NULL)
		
Util::myDisconnect(m_pWiredConnections,
				    SIGNAL(currentIndexChanged
					   (const QString &)), this,
				    SLOT(setWiredAutoConnection
					 (const QString &)));
	

if (m_pEnableLogging != NULL)
		
Util::myDisconnect(m_pEnableLogging, SIGNAL(stateChanged(int)),
				    this, SLOT(updateCheckboxes()));
	

if (m_pLogPath != NULL)
		
Util::myDisconnect(m_pLogPath,
...
Util::myDisconnect(m_pBrowse, SIGNAL(clicked()), this,
				    SLOT(browseLogs()));
	

if (m_pLogLevel != NULL)
		
Util::myDisconnect(m_pLogLevel,
...
Util::myDisconnect(m_pViewLog, SIGNAL(clicked()), this,
				    SLOT(viewLog()));
	

if (m_pLogsToKeep != NULL)
		
Util::myDisconnect(m_pLogsToKeep, SIGNAL(valueChanged(int)),
				    this, SLOT(enableSaveBtns()));
	

if (m_pRollBySize != NULL)
		
Util::myDisconnect(m_pRollBySize, SIGNAL(stateChanged(int)),
				    this, SLOT(updateCheckboxes()));
	

if (m_pSizeToRoll != NULL)
		
Util::myDisconnect(m_pSizeToRoll, SIGNAL(valueChanged(int)),
				    this, SLOT(enableSaveBtns()));
	

if (m_pLoggingSave != NULL)
		
Util::myDisconnect(m_pLoggingSave, SIGNAL(clicked()), this,
				    SLOT(configUpdate()));
...
Util::myDisconnect(m_pCheckSupplicants,
				    SIGNAL(stateChanged(int)), this,
				    SLOT(enableSaveBtns()));
...
Util::myDisconnect(m_pDisconnectAtLogoff,
				    SIGNAL(stateChanged(int)), this,
				    SLOT(enableSaveBtns()));
...
Util::myDisconnect(m_pAllowMachineAuthContinue,
				    SIGNAL(stateChanged(int)), this,
				    SLOT(enableSaveBtns()));
...
Util::myDisconnect(m_pForceMulticast,
				    SIGNAL(stateChanged(int)), this,
				    SLOT(enableSaveBtns()));
...
Util::myDisconnect(m_pScanTimeout, SIGNAL(valueChanged(int)),
				    this, SLOT(enableSaveBtns()));
	

if (m_pAssocTimeout != NULL)
		
Util::myDisconnect(m_pAssocTimeout, SIGNAL(valueChanged(int)),
				    this, SLOT(enableSaveBtns()));
	

if (m_pPassiveInterval != NULL)
		
Util::myDisconnect(m_pPassiveInterval,
...
Util::myDisconnect(m_pPMKSACacheRefresh,
				    SIGNAL(valueChanged(int)), this,
				    SLOT(enableSaveBtns()));
...
Util::myDisconnect(m_pPMKSACacheTimeout,
				    SIGNAL(valueChanged(int)), this,
				    SLOT(enableSaveBtns()));
...
Util::myDisconnect(m_pSettingsReset, SIGNAL(clicked()), this,
				    SLOT(resetAdvSettings()));
	

if (m_pAdvSettingsSave != NULL)
		
Util::myDisconnect(m_pAdvSettingsSave, SIGNAL(clicked()), this,
				    SLOT(configUpdate()));
...
Util::myDisconnect(m_pAuthPeriod, SIGNAL(valueChanged(int)),
				    this, SLOT(enableSaveBtns()));
	

if (m_pHeldPeriod != NULL)
		
Util::myDisconnect(m_pHeldPeriod, SIGNAL(valueChanged(int)),
				    this, SLOT(enableSaveBtns()));
	

if (m_pIdlePeriod != NULL)
		
Util::myDisconnect(m_pIdlePeriod, SIGNAL(valueChanged(int)),
				    this, SLOT(enableSaveBtns()));
	

if (m_pStaleKey != NULL)
		
Util::myDisconnect(m_pStaleKey, SIGNAL(valueChanged(int)),
				    this, SLOT(enableSaveBtns()));
	

if (m_pMaxStarts != NULL)
		
Util::myDisconnect(m_pMaxStarts, SIGNAL(valueChanged(int)),
				    this, SLOT(enableSaveBtns()));
	

if (m_pTimersReset != NULL)
		
Util::myDisconnect(m_pTimersReset, SIGNAL(clicked()), this,
				    SLOT(resetAdvTimers()));
	

if (m_pAdvTimersSave != NULL)
		
Util::myDisconnect(m_pAdvTimersSave, SIGNAL(clicked()), this,
				    SLOT(configUpdate()));
	

Util::myDisconnect(m_pEmitter, SIGNAL(signalConnConfigUpdate()), this,
			     SLOT(updateConnectionLists()));
...
QLabel * pTemp = NULL;
	    ...
	    // load form
	    m_pRealForm =
	    FormLoader::buildform("ConnectionManagerWindow.ui",
				  m_pParentWindow);
...
m_pRealForm->setWindowFlags(flags);
	    ...
	    m_pHelpButton =
	    qFindChild < QPushButton * >(m_pRealForm, "buttonHelp");
	
m_pCloseButton =
	    qFindChild < QPushButton * >(m_pRealForm, "buttonClose");
	
m_pMainTab =
	    qFindChild < QTabWidget * >(m_pRealForm, "mainTabControl");
	

m_pNetworkPrioritiesButton =
	    qFindChild < QPushButton * >(m_pRealForm,
					 "buttonOptionsNetworkPriorities");
	
m_pWiredConnections =
	    qFindChild < QComboBox * >(m_pRealForm,
				       "comboOptionsWirelessConnections");
	
m_pWiredAutoConnect =
	    qFindChild < QCheckBox * >(m_pRealForm, "checkboxWiredAutoConnect");
	
m_pWirelessAutoConnect =
	    qFindChild < QCheckBox * >(m_pRealForm,
				       "checkboxWirelessAutoConnect");
	

m_pDeleteConnButton =
	    qFindChild < QPushButton * >(m_pRealForm, "buttonDeleteConnection");
	
m_pEditConnButton =
	    qFindChild < QPushButton * >(m_pRealForm, "buttonEditConnection");
	
m_pNewConnButton =
	    qFindChild < QPushButton * >(m_pRealForm, "buttonNewConnection");
	
m_pConnectionsTable =
	    qFindChild < QTableWidget * >(m_pRealForm,
					  "dataTableConnectionProfiles");
	

	    // Logging settings
	    m_pEnableLogging =
	    qFindChild < QCheckBox * >(m_pRealForm, "enableLogging");
	
if (m_pEnableLogging != NULL)
		m_pEnableLogging->setText(tr("Enable Logging to a File"));
	

m_pLogPath = qFindChild < QLineEdit * >(m_pRealForm, "logDirectory");
	
if (m_pLogPath != NULL)
		m_pLogPath->setText(tr("Log Directory"));
	

m_pBrowse = qFindChild < QPushButton * >(m_pRealForm, "browseButton");
	
if (m_pBrowse != NULL)
		m_pBrowse->setText(tr("Browse"));
	

m_pLogLevel = qFindChild < QComboBox * >(m_pRealForm, "logLevel");
	
m_pViewLog =
	    qFindChild < QPushButton * >(m_pRealForm, "viewLogButton");
	
if (m_pViewLog != NULL)
		m_pViewLog->setText(tr("View Log"));
	

m_pLogsToKeep =
	    qFindChild < QSpinBox * >(m_pRealForm, "numLogsToKeep");
	
m_pRollBySize =
	    qFindChild < QCheckBox * >(m_pRealForm, "rollBySizeBox");
	
if (m_pRollBySize != NULL)
		m_pRollBySize->setText(tr("Roll Logs by Size"));
	

m_pSizeToRoll =
	    qFindChild < QSpinBox * >(m_pRealForm, "sizeToRollBox");
	
m_pLoggingSave =
	    qFindChild < QPushButton * >(m_pRealForm, "loggingSave");
	
if (m_pLoggingSave != NULL)
		m_pLoggingSave->setText(tr("Save"));
...
xlate_value(pTemp, tr("MB"));
	    ...
	    // advanced settings tab objects
	    m_pCheckSupplicants =
	    qFindChild < QCheckBox * >(m_pRealForm, "runOtherSuppCheck");
	
if (m_pCheckSupplicants != NULL)
		m_pCheckSupplicants->
		    setText(tr("Run other supplicant check on startup"));
	

m_pDisconnectAtLogoff =
	    qFindChild < QCheckBox * >(m_pRealForm, "disconnectOnLogoff");
	
if (m_pDisconnectAtLogoff != NULL)
		m_pDisconnectAtLogoff->setText(tr("Disconnect on Logoff"));
	

m_pAllowMachineAuthContinue =
	    qFindChild < QCheckBox * >(m_pRealForm, "allowMachineAuthRemain");
	
if (m_pAllowMachineAuthContinue != NULL)
		m_pAllowMachineAuthContinue->
		    setText(tr
			    ("Allow logged on users to keep the machines authentication"));
	

m_pForceMulticast =
	    qFindChild < QCheckBox * >(m_pRealForm, "forceMulticast");
	
if (m_pForceMulticast != NULL)
		m_pForceMulticast->
		    setText(tr
			    ("Force wired connections to use the multicast MAC address"));
	

m_pScanTimeout =
	    qFindChild < QSpinBox * >(m_pRealForm, "scanTimeout");
	
m_pAssocTimeout =
	    qFindChild < QSpinBox * >(m_pRealForm, "assocTimeout");
	
m_pPassiveInterval =
	    qFindChild < QSpinBox * >(m_pRealForm, "passiveScanInterval");
	
m_pPMKSACacheRefresh =
	    qFindChild < QSpinBox * >(m_pRealForm, "pmksaRefresh");
	
m_pPMKSACacheTimeout =
	    qFindChild < QSpinBox * >(m_pRealForm, "pmksaTimeout");
	
m_pSettingsReset =
	    qFindChild < QPushButton * >(m_pRealForm, "resetButton");
	
if (m_pSettingsReset != NULL)
		m_pSettingsReset->setText(tr("Reset"));
	

m_pAdvSettingsSave =
	    qFindChild < QPushButton * >(m_pRealForm, "advSaveBtn");
	
if (m_pAdvSettingsSave != NULL)
		m_pAdvSettingsSave->setText(tr("Save"));
...
xlate_value(pTemp, tr("Advanced Settings"));
	    ...
	    // advanced timers
	    m_pAuthPeriod =
	    qFindChild < QSpinBox * >(m_pRealForm, "authPeriodBox");
	
m_pHeldPeriod =
	    qFindChild < QSpinBox * >(m_pRealForm, "heldPeriodBox");
	
m_pIdlePeriod =
	    qFindChild < QSpinBox * >(m_pRealForm, "idlePeriodBox");
	
m_pStaleKey =
	    qFindChild < QSpinBox * >(m_pRealForm, "staleWepTimeout");
...
if (m_pTimersReset != NULL)
		m_pTimersReset->setText(tr("Reset"));
	

m_pAdvTimersSave =
	    qFindChild < QPushButton * >(m_pRealForm, "advTimerSave");
	
if (m_pAdvTimersSave != NULL)
		m_pAdvTimersSave->setText(tr("Save"));
...
m_pNetworkPrioritiesButton->
		    setText(tr("Set Network Priorities"));
	

if (m_pWiredAutoConnect != NULL)
		
m_pWiredAutoConnect->
		    setText(tr("Automatically Establish Connection"));
...
m_pConnectionsTable->horizontalHeaderItem(0)->
		    setText(tr("Name"));
		
m_pConnectionsTable->horizontalHeaderItem(1)->
		    setText(tr("Interface"));
...
pWiredOptionsHeader =
	    qFindChild < QLabel * >(m_pRealForm, "headerWiredOptions");
...
pWirelessOptionsHeader =
	    qFindChild < QLabel * >(m_pRealForm, "headerWirelessOptions");
...
pAdvancedOptionsHeader =
	    qFindChild < QLabel * >(m_pRealForm, "headerAdvancedOptions");
...
pConnectionsHeader =
	    qFindChild < QLabel * >(m_pRealForm, "headerConnectionProfiles");
...
Util::myConnect(m_pConnectionsTable,
				 SIGNAL(itemSelectionChanged()), this,
				 SLOT(handleConnectionListSelectionChange()));
...
Util::myConnect(m_pDeleteConnButton, SIGNAL(clicked()), this,
				 SLOT(deleteSelectedConnection()));
	

if (m_pEditConnButton != NULL)
		
Util::myConnect(m_pEditConnButton, SIGNAL(clicked()), this,
				 SLOT(editSelectedConnection()));
	

if (m_pNetworkPrioritiesButton != NULL)
		
Util::myConnect(m_pNetworkPrioritiesButton, SIGNAL(clicked()),
				 this, SLOT(showPriorityDialog()));
	

if (m_pNewConnButton != NULL)
		
Util::myConnect(m_pNewConnButton, SIGNAL(clicked()), this,
				 SLOT(createNewConnection()));
	

if (m_pWirelessAutoConnect != NULL)
		
Util::myConnect(m_pWirelessAutoConnect,
				 SIGNAL(stateChanged(int)), this,
				 SLOT(enableDisableWirelessAutoConnect(int)));
	

if (m_pWiredAutoConnect != NULL)
		
Util::myConnect(m_pWiredAutoConnect, SIGNAL(stateChanged(int)),
				 this,
				 SLOT(enableDisableWiredAutoConnect(int)));
...
Util::myConnect(m_pWiredConnections,
				 SIGNAL(currentIndexChanged(const QString &)),
				 this,
				 SLOT(setWiredAutoConnection(const QString &)));
	

if (m_pEnableLogging != NULL)
		
Util::myConnect(m_pEnableLogging, SIGNAL(stateChanged(int)),
				 this, SLOT(updateCheckboxes()));
	

if (m_pLogPath != NULL)
		
Util::myConnect(m_pLogPath,
				 SIGNAL(textChanged(const QString &)), this,
				 SLOT(enableSaveBtns()));
...
Util::myConnect(m_pBrowse, SIGNAL(clicked()), this,
				 SLOT(browseLogs()));
	

if (m_pLogLevel != NULL)
		
Util::myConnect(m_pLogLevel, SIGNAL(currentIndexChanged(int)),
				 this, SLOT(enableSaveBtns()));
	

if (m_pViewLog != NULL)
		
Util::myConnect(m_pViewLog, SIGNAL(clicked()), this,
				 SLOT(viewLog()));
	

if (m_pLogsToKeep != NULL)
		
Util::myConnect(m_pLogsToKeep, SIGNAL(valueChanged(int)), this,
				 SLOT(enableSaveBtns()));
	

if (m_pRollBySize != NULL)
		
Util::myConnect(m_pRollBySize, SIGNAL(stateChanged(int)), this,
				 SLOT(updateCheckboxes()));
	

if (m_pSizeToRoll != NULL)
		
Util::myConnect(m_pSizeToRoll, SIGNAL(valueChanged(int)), this,
				 SLOT(enableSaveBtns()));
	

if (m_pLoggingSave != NULL)
		
Util::myConnect(m_pLoggingSave, SIGNAL(clicked()), this,
				 SLOT(configUpdate()));
...
Util::myConnect(m_pCheckSupplicants, SIGNAL(stateChanged(int)),
				 this, SLOT(enableSaveBtns()));
	

if (m_pDisconnectAtLogoff != NULL)
		
Util::myConnect(m_pDisconnectAtLogoff,
				 SIGNAL(stateChanged(int)), this,
				 SLOT(enableSaveBtns()));
...
Util::myConnect(m_pAllowMachineAuthContinue,
				 SIGNAL(stateChanged(int)), this,
				 SLOT(enableSaveBtns()));
...
Util::myConnect(m_pForceMulticast, SIGNAL(stateChanged(int)),
				 this, SLOT(enableSaveBtns()));
	

if (m_pScanTimeout != NULL)
		
Util::myConnect(m_pScanTimeout, SIGNAL(valueChanged(int)),
				 this, SLOT(enableSaveBtns()));
	

if (m_pAssocTimeout != NULL)
		
Util::myConnect(m_pAssocTimeout, SIGNAL(valueChanged(int)),
				 this, SLOT(enableSaveBtns()));
	

if (m_pPassiveInterval != NULL)
		
Util::myConnect(m_pPassiveInterval, SIGNAL(valueChanged(int)),
				 this, SLOT(enableSaveBtns()));
	

if (m_pPMKSACacheRefresh != NULL)
		
Util::myConnect(m_pPMKSACacheRefresh,
				 SIGNAL(valueChanged(int)), this,
				 SLOT(enableSaveBtns()));
...
Util::myConnect(m_pPMKSACacheTimeout,
				 SIGNAL(valueChanged(int)), this,
				 SLOT(enableSaveBtns()));
...
Util::myConnect(m_pSettingsReset, SIGNAL(clicked()), this,
				 SLOT(resetAdvSettings()));
	

if (m_pAdvSettingsSave != NULL)
		
Util::myConnect(m_pAdvSettingsSave, SIGNAL(clicked()), this,
				 SLOT(configUpdate()));
...
Util::myConnect(m_pAuthPeriod, SIGNAL(valueChanged(int)), this,
				 SLOT(enableSaveBtns()));
	

if (m_pHeldPeriod != NULL)
		
Util::myConnect(m_pHeldPeriod, SIGNAL(valueChanged(int)), this,
				 SLOT(enableSaveBtns()));
	

if (m_pIdlePeriod != NULL)
		
Util::myConnect(m_pIdlePeriod, SIGNAL(valueChanged(int)), this,
				 SLOT(enableSaveBtns()));
	

if (m_pStaleKey != NULL)
		
Util::myConnect(m_pStaleKey, SIGNAL(valueChanged(int)), this,
				 SLOT(enableSaveBtns()));
	

if (m_pMaxStarts != NULL)
		
Util::myConnect(m_pMaxStarts, SIGNAL(valueChanged(int)), this,
				 SLOT(enableSaveBtns()));
	

if (m_pTimersReset != NULL)
		
Util::myConnect(m_pTimersReset, SIGNAL(clicked()), this,
				 SLOT(resetAdvTimers()));
	

if (m_pAdvTimersSave != NULL)
		
Util::myConnect(m_pAdvTimersSave, SIGNAL(clicked()), this,
				 SLOT(configUpdate()));
	

Util::myConnect(m_pEmitter, SIGNAL(signalConnConfigUpdate()), this,
			  SLOT(updateConnectionLists()));
...
if (m_pConnectionsTable != NULL)
		
 {
		    ...
		    m_pConnectionsTable->horizontalHeader()->
		    setResizeMode(QHeaderView::Fixed);
		

m_pConnectionsTable->horizontalHeader()->setResizeMode(0,
									 QHeaderView::
									 Stretch);
...
pToolsMenu->addSeparator();
			    ...
			    if (xsupgui_request_get_are_administrator(&admin) ==
				REQUEST_SUCCESS)
...
pAction->setFont(pMenuBar->
								  font());
						
Util::myConnect(pAction,
								 SIGNAL
								 (triggered()),
								 this,
								 SLOT
...
m_pWirelessAutoConnect->
			    setChecked((pConfig->
					flags & CONFIG_GLOBALS_ASSOC_AUTO) ==
...
if (xsupgui_request_enum_connections(x, &connEnum) ==
			     REQUEST_SUCCESS)
...
if (((connEnum[i].ssid == NULL)
					      || (strlen(connEnum[i].ssid) ==
						  0))
					     && (connEnum[i].priority == 1))
...
if (xsupgui_request_get_connection_config
	     (CONFIG_LOAD_GLOBAL, connectionName.toAscii().data(),
	      &myConn) == REQUEST_SUCCESS)
		
 {
		    ...
		    if (xsupgui_request_get_are_administrator(&are_admin) !=
			REQUEST_SUCCESS)
...
QMessageBox::critical(this, tr("Error"),
					       tr
					       ("Unable to determine if you have permissions to edit this setting."));
...
QMessageBox::critical(this, tr("Error"),
					       tr
					       ("The default wired connection is defined in the system configuration.  You must be an administrator to change it."));
...
if (are_admin == FALSE)
			x++;	// Don't process global settings if we aren't admin.
...
QMessageBox::critical(this,
								       ...
								       ("Error"),
								       tr
								       ("Unable to reset the priority settings on connection %1.  The wired default behavior may not be what is expected.").
								       arg
								       (connEnum
									[i].
									name));
...
xsupgui_request_free_connection_config
				    ...
				    if ((!alreadySet)
					&& ((connEnum[i].ssid == NULL)
					    || (strlen(connEnum[i].ssid) == 0))
					&& (connectionName ==
					    QString(connEnum[i].name)))
...
QMessageBox::critical(this,
								       ...
								       ("Error"),
								       tr
								       ("Unable to set the priority settings on connection %1.  The wired default behavior may not be what is expected.").
								       arg
								       (connEnum
									[i].
									name));
...
setWiredAutoConnection(m_pWiredConnections->
						currentText());
...
clearWiredAutoConnection(m_pWiredConnections->
						  currentText());
...
if (m_pConnections[i].ssid == NULL
				     || QString(m_pConnections[i].ssid).
				     isEmpty())
					
wiredConnVector.
					    append(QString
						   (m_pConnections[i].name));
				
}
			

			    // we now have vector of connections. Now sort them.
			    std::sort(wiredConnVector.begin(),
				      wiredConnVector.end());
			

for (int i = 0; i < wiredConnVector.size(); i++)
				
m_pWiredConnections->addItem(wiredConnVector.
							      at(i));
...
if (m_pConnections != NULL && m_pConnectionsTable != NULL)
		
 {
		...
		m_pConnectionsTable->setRowCount(std::max <
						     int >(this->
							   m_minConnListRowCount,
							   m_nConnections));
...
int retVal =
			    xsupgui_request_get_connection_config(m_pConnections
								  [i].
								  config_type,
								  m_pConnections
								  [i].name,
...
if ((pConfig->flags & CONFIG_VOLATILE_CONN) !=
				     0)
...
nameItem =
				    new QTableWidgetItem(m_pConnections[i].name,
							 QTableWidgetItem::
							 UserType +
							 m_pConnections[i].
							 config_type);
...
m_pConnectionsTable->setItem(i, 0,
								      nameItem);
...
adapterItem =
				    new QTableWidgetItem(adapterTypeStr, 0);
				
if (adapterItem != NULL)
					
m_pConnectionsTable->setItem(i, 1,
								      adapterItem);
...
QTableWidgetItem * nameItem =
			    m_pConnectionsTable->item(selItem->row(), 0);
...
unsigned char my_config_type =
			    (nameItem->type() - QTableWidgetItem::UserType);
			

			    // first check if connection is in use
			    // if so, don't allow deleting  
			    
if (xsupgui_request_get_is_connection_in_use
				 (connName.toAscii().data(),
				  &inuse) == REQUEST_SUCCESS)
...
QMessageBox::warning(m_pRealForm,
							      ...
							      ("Connection In Use"),
							      tr
							      ("The connection '%1' cannot be deleted because it is currently in use.  Please disconnect from the network before deleting the connection.").
							      arg(connName));
...
QString message;
				    ...
				    if (XSupWrapper::
					isDefaultWiredConnection(connName))
					
message =
					    tr
					    ("The connection '%1' is set as the default connection for one of your wired adapters.  Are you sure you want to delete it?").
					    arg(connName);
...
message =
					    tr
					    ("Are you sure you want to delete the connection '%1'?").
					    arg(connName);
				    ...
				    bool result =
				    XSupWrapper::
				    getConfigConnection(my_config_type,
							connName, &pConfig);
...
message =
						    tr
						    ("The connection '%1' is in your preferred connection list.  Are you sure you want to delete it?").
						    arg(connName);
...
QMessageBox::
						    critical(m_pRealForm,
							     tr
							     ("Error Deleting Connection"),
							     tr
							     ("An error occurred when attempting to delete the connection '%1'.  If the connection is in use, please disconnect and try again.").
							     arg(connName));
...
QMessageBox::
								    ...
								    (m_pRealForm,
								     ...
								     tr
								     ("An error occurred while attempting to delete the profile '%1'").
								     arg
								     (pProfile->
								      name));
...
QMessageBox::
									    ...
									    (m_pRealForm,
									     tr
									     ("Error Deleting Trusted Server"),
									     tr
									     ("The trused server '%1' cannot be deleted because it is being used by multiple profiles").
									     arg
									     (pServer->
									      name));
...
QMessageBox::
							    ...
							    (m_pRealForm,
							     ...
							     ("Error Deleting Profile"),
							     tr
							     ("The profile '%1' cannot be deleted because it is being used by multiple connection profiles").
							     arg(pProfile->
								 name));
...
m_pPrefDlg =
		    new PreferredConnections(m_psupplicant, this, m_pRealForm);
...
Util::myConnect(m_pPrefDlg, SIGNAL(close()), this,
				  SLOT(cleanupPriorityDialog()));
...
Util::myDisconnect(m_pPrefDlg, SIGNAL(close()), this,
				    SLOT(cleanupPriorityDialog()));
...
int config_type =
			    (item->type() - QTableWidgetItem::UserType);
...
QMessageBox::critical(m_pRealForm, tr("Error"),
						       tr
						       ("An error occurred when attempting to launch the Connection Wizard"));
...
QMessageBox::critical(m_pRealForm,
				       tr("Error saving connection data"),
				       tr
				       ("An error occurred while saving the configuration data you provided."));
...
void ConnectMgrDlg::finishMachineAuthWizard(bool success, const QString &,
						 const QString &) 
{
...
QMessageBox::critical(m_pRealForm,
				       tr
				       ("Error saving machine authentication data"),
				       tr
				       ("An error occurred while saving the machine authentication data you provided."));
...
Util::myDisconnect(m_pMachineAuth, SIGNAL(cancelled()), this,
				    SLOT(cleanupMachineAuthWizard()));
		
Util::myDisconnect(m_pMachineAuth,
				    SIGNAL(finished
					   (bool, const QString &,
					    const QString &)), this,
				    SLOT(finishMachineAuthWizard
					 (bool, const QString &,
					  const QString &)));
...
void ConnectMgrDlg::editConnection(int config_type,
...
success =
	    XSupWrapper::getConfigConnection(config_type, connName, &pConfig);
...
bool editable = true;
		    ...
		    if (xsupgui_request_get_is_connection_in_use
			(connName.toAscii().data(), &inuse) == REQUEST_SUCCESS)
...
QMessageBox::warning(m_pRealForm,
						      ...
						      tr
						      ("The connection '%1' cannot be edited because it is currently in use.  Please disconnect from the network before editing the connection.").
						      arg(connName));
...
success =
				    XSupWrapper::getConfigProfile(profile_type,
								  QString
								  (pConfig->
								   profile),
								  &pProfile);
...
success =
				    XSupWrapper::
				    getTrustedServerForProfile(profile_type,
							       QString
							       (pProfile->name),
							       &pServer,
							       &ts_type);
...
wizData.initFromSupplicantProfiles(config_type,
							    pConfig, pProfile,
							    pServer);
...
peapconfig =
				    (struct config_eap_peap *)pProfile->method->
				    method_data;
...
if (m_pConnWizard == NULL)
				
 {
				    ...
				    // create the wizard if it doesn't already exist
				    m_pConnWizard =
				    new ConnectionWizard(QString(""), this,
							 m_pRealForm,
							 m_pEmitter);
...
if ((selItem->row() >= 0)
			     && (selItem->row() < m_nConnections))
				
 {
				
QTableWidgetItem * nameItem =
				    m_pConnectionsTable->item(selItem->row(),
							      0);
...
m_pMachineAuth =
	    new MachineAuthWizard(QString(""), this, m_pRealForm, m_pEmitter);
...
Util::myConnect(m_pMachineAuth, SIGNAL(cancelled()),
					 this,
					 SLOT(cleanupMachineAuthWizard()));
			
Util::myConnect(m_pMachineAuth,
					 SIGNAL(finished
						(bool, const QString &,
						 const QString &)), this,
					 SLOT(finishMachineAuthWizard
...
if (xsupgui_request_get_connection_config
			      (CONFIG_LOAD_GLOBAL,
			       ...
			       &pConn) == REQUEST_SUCCESS)
				
 {
				
xsupgui_request_get_profile_config
				    (CONFIG_LOAD_GLOBAL,
				     "Machine Authentication Profile", &pProf);
				
xsupgui_request_get_trusted_server_config
				    (CONFIG_LOAD_GLOBAL,
				     "Machine Authentication Trusted Server",
				     &pServer);
				

if (wizData.
				      initFromSupplicantProfiles
				      (CONFIG_LOAD_GLOBAL, pConn, pProf,
				       pServer) == true)
					
 {
					    ...
					    if
					    (xsupgui_request_get_globals_config
					     (&pGlobals) == REQUEST_SUCCESS)
...
xsupgui_request_free_config_globals
						    (&pGlobals);
...
xsupgui_request_free_trusted_server_config
					    (&pServer);
...
QMessageBox::critical(this,
								tr
								("Machine Authentication Configuration Error"),
								tr
								("There was an error gathering existing machine authentication data to edit."));
...
QMessageBox::critical(this, tr("Error"),
				       tr
				       ("Unable to allocate memory needed to store configuration globals."));
...
QMessageBox::critical(this, tr("Form design error"),
					       tr
					       ("You have selected a log level setting that is not understood.  Your form design may be incorrect.  Defaulting to NORMAL logging."));
...
globals->assoc_timeout =
		    atoi(m_pAssocTimeout->text().toAscii());
...
globals->active_timeout =
		    atoi(m_pScanTimeout->text().toAscii());
...
globals->idleWhile_timeout =
		    atoi(m_pIdlePeriod->text().toAscii());
...
QMessageBox::critical(this, tr("Cannot Save"),
				       tr
				       ("Unable to save your configuration data."));
...
QString directory =
	    QFileDialog::getExistingDirectory(m_pRealForm,
					      
tr("Select Logging Folder"),
					      logDir);
...
if ((m_pViewLogDialog == NULL)
	      || (m_pViewLogDialog->attach() == false))
		
 {
		
QMessageBox::critical(this, tr("Form Error"),
				       tr
				       ("Unable to load the form 'ViewLogWindow.ui'."));
...
Util::myConnect(m_pViewLogDialog, SIGNAL(close()), this,
			  SLOT(cleanupuiWindowViewLogs()));
...
Util::myDisconnect(m_pViewLogDialog, SIGNAL(close()), this,
				    SLOT(cleanupuiWindowViewLogs()));
...
if ((xsupgui_request_get_are_administrator(&areadmin) !=
	       REQUEST_SUCCESS) || (areadmin != TRUE))
...
QMessageBox::critical(this, tr("Request Failed"),
				       tr
				       ("Unable to get global configuration settings."));
...
if ((myglobals->logtype == LOGGING_FILE)
	      && (myglobals->flags & CONFIG_GLOBALS_ROLL_LOGS) ==
...
m_pSizeToRoll->setValue(myglobals->size_to_roll);
	    ...
	    // advanced settings
	    if ((myglobals->flags & CONFIG_GLOBALS_DETECT_ON_STARTUP) ==
...
if ((myglobals->flags & CONFIG_GLOBALS_DISCONNECT_AT_LOGOFF) ==
	      CONFIG_GLOBALS_DISCONNECT_AT_LOGOFF)
...
if ((myglobals->flags & CONFIG_GLOBALS_ALLOW_MA_REMAIN) ==
	      CONFIG_GLOBALS_ALLOW_MA_REMAIN)
