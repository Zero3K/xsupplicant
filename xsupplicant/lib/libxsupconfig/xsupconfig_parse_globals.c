...
parser globals[] = {
  {"Log_Path", NULL, FALSE, OPTION_GLOBAL_CONFIG_ONLY, &xsupconfig_parse_logpath},
  {"Log_Level", NULL, FALSE, OPTION_GLOBAL_CONFIG_ONLY, &xsupconfig_parse_loglevel},
  {"Friendly_Warnings", NULL, FALSE, OPTION_GLOBAL_CONFIG_ONLY, &xsupconfig_parse_friendly_warnings},
  {"Log_Facility", NULL, FALSE, OPTION_GLOBAL_CONFIG_ONLY, &xsupconfig_parse_log_facility},
  {"IPC_Group", NULL, FALSE, OPTION_GLOBAL_CONFIG_ONLY, &xsupconfig_parse_ipc_group},
  {"Auth_Period", NULL, FALSE, OPTION_GLOBAL_CONFIG_ONLY, &xsupconfig_parse_auth_period},
  {"Held_Period", NULL, FALSE, OPTION_GLOBAL_CONFIG_ONLY, &xsupconfig_parse_held_period},
  {"Idle_While", NULL, FALSE, OPTION_GLOBAL_CONFIG_ONLY, &xsupconfig_parse_idle_while},
  {"Association", NULL, FALSE, OPTION_GLOBAL_CONFIG_ONLY, &xsupconfig_parse_association},
  {"Stale_Key_Timeout", NULL, FALSE, OPTION_GLOBAL_CONFIG_ONLY, &xsupconfig_parse_stale_key_timeout},
  {"Max_Starts", NULL, FALSE, OPTION_GLOBAL_CONFIG_ONLY, &xsupconfig_parse_max_starts},
  {"Allmulti", NULL, FALSE, OPTION_GLOBAL_CONFIG_ONLY, &xsupconfig_parse_allmulti},
  {"Roaming", NULL, FALSE, OPTION_GLOBAL_CONFIG_ONLY, &xsupconfig_parse_roaming},
  {"Passive_Scanning", NULL, FALSE, OPTION_GLOBAL_CONFIG_ONLY, &xsupconfig_parse_passive_scanning},
  ...
  {"Logs_To_Keep", NULL, FALSE, OPTION_GLOBAL_CONFIG_ONLY, &xsupconfig_parse_logs_to_keep},
  {"Log_Size_To_Roll", NULL, FALSE, OPTION_GLOBAL_CONFIG_ONLY, &xsupconfig_parse_log_size_to_roll},
  {"Roll_Logs", NULL, FALSE, OPTION_GLOBAL_CONFIG_ONLY, &xsupconfig_parse_roll_logs},
  {"Disconnect_at_Logoff", NULL, FALSE, OPTION_GLOBAL_CONFIG_ONLY, &xsupconfig_disconnect_at_logoff},
  {"PMKSA_Age_Out_Time", NULL, FALSE, OPTION_GLOBAL_CONFIG_ONLY, &xsupconfig_parse_pmksa_age_out},
  {"PMKSA_Refresh_Time", NULL, FALSE, OPTION_GLOBAL_CONFIG_ONLY, &xsupconfig_parse_pmksa_refresh_time},
